---
name: kexue-shangwang
description: 给 agent 的一份手册：问清用户情况，替他挑机器，装 Xray（Reality，可选 XHTTP 套 Cloudflare）和 Hysteria2，生成含 DNS 的 Clash 配置，跑完验证。只有步骤和判定标准，不讲原因。 触发：用户要在中国大陆配置科学上网 / VPS / 代理 / Clash，或问该买哪里的服务器。
version: 2026-09-15
source: https://blog.songchengtie.me/agent/kexue-shangwang.md
---
# 给 AI 的说明
